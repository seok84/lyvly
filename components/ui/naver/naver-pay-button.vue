        ...
        <div id="NPAY_BUTTON_BOX_ID" class="npay_button_box ">
                    ...
                    <tbody>
                        <tr>
                            <td class="npay_btn_item">
                                <a id="naverPayBtn" href="javascript:void(0)" class="npay_btn_link npay_btn_pay btn_green"
                                    style="box-sizing:content-box; " title="새창" @click="NaverPay_buyButtonHandler"><span
                                        class="npay_blind">네이버페이 구매하기</span></a>
                            </td>
                            <template v-if="orderType == 'item'">
                                <td class="npay_btn_item btn_width">
                                    <a id="NPAY_WISH_LINK_IDNC_ID_1589869366282396" href="javascript:void(0)"
                                        class="npay_btn_link npay_btn_zzim " style="box-sizing:content-box; " title="새창"
                                        @click="NaverPay_wishlistButtonHandler"><span class="npay_blind">찜하기</span></a>
                                </td>
                            </template>
                        </tr>
                    </tbody>
            ...
            <div id="NPAY_EVENT_ID" class="npay_event">
                ...
                <p id="NPAY_PROMOTION_IDNC_ID_1589869366282396" class="npay_event_text">
                    <strong class="event_title">이벤트</strong><a href="http://event2.pay.naver.com/event/benefit/list"
                        class="event_link" target="_blank">네이버페이</a>
                </p>
...
module.exports = {
    ...
    methods: {
        // 네이버 페이 요청 파라미터를 가져옴.
        getNaverPayParamAfterVerification(requestType, orderType) {
        ...
        // 찜하기
        NaverPay_wishlistButtonHandler() {
