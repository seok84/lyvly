<template>
    <section class="transfer-step02">
        <h3 class="page-title user-inner">기존회원 가입(이관)</h3>
        <p class="text-center">
            이관된 회원정보를 확인해주시고, 새로운 농협 라이블리 도매몰에서 필요한 정보를 입력해주세요
        </p>
                ...
                <form @submit.prevent="handleSubmit(validate)">
                    <dl class="accordion-list">
                        ...
                        <dd class="list-wrap">
                            ...
                            <div class="radio-wrap">
                                ...
                                <label for="normalUser"><input type="radio" name="joinUserType" id="normalUser" disabled>
                            ...
                            <ValidationProvider rules="required" v-slot="{ errors }" class="form-line form-button disabled">
                    ...
                    <dl class="accordion-list term-list">
                        ...
                        <dd class="list-wrap">
                            ...
                            <div class="btn-wrap mt-40  mb-40">
                                <nuxt-link to="/user/transfer-complete" class="btn btn-secondary">등록하기</nuxt-link>
                            </div>
                        </dd>
                    </dl>
                </form>
...
/* radio */
.transfer-step02 .radio-wrap label {
    margin-right: 4rem;
    font-size: 1.5rem;
}

/* form-line */
.transfer-step02 .form-title {
    margin-top: 4rem;
}
...
.transfer-step02 .form-title.mt-20 {
    margin-top: 2rem;
}

.transfer-step02 .form-title+.radio-wrap {
    margin-top: -1rem;
    height: auto;
}
...
.transfer-step02 .user-address .btn-black {
    pointer-events: initial;
    border-color: #000;
    background-color: #000;
}

.transfer-step02 .user-address .btn-black:hover {
    border-color: #b9b9b9;
    background-color: #b9b9b9;
}


.transfer-step02 .info-dot {
    position: relative;
    line-height: 1.33;
    margin-top: 0.6rem;
    padding-left: 0.4rem;
...
.transfer-step02 .info-dot::before {
    content: '';
    position: absolute;
    top: 0;
    left: 0;
...
@media (max-width: 480px) {
    .transfer-step02 .double-form-line .select-basic {
        max-width: 12.4rem;
    }
}
</style>