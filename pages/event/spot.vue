                        ...
                        <div class="sort_area">
                            ...
                            <div class="sort_type">
                                <select class="btn_sort" @change="sorting($event)">
                                    <option value="ORDERING__ASC"
                                        :selected="param.orderBy + '__' + param.sort === 'ORDERING__ASC'">최신순</option>
                                    <option value="HITS__DESC"
                                        :selected="param.orderBy + '__' + param.sort === 'HITS__DESC'">인기순</option>
                                    <option value="SALE_PRICE__DESC"
                                        :selected="param.orderBy + '__' + param.sort === 'SALE_PRICE__DESC'">높은 가격순</option>
                                    <option value="SALE_PRICE__ASC"
                                        :selected="param.orderBy + '__' + param.sort === 'SALE_PRICE__ASC'">낮은 가격순</option>
                                </select>
                                ...
                                <div class="img_shadow">
                                    ...
                                    <div class="txt_area">
                                        ...
                                        <p class="title"><a href="javascript:void(0)"
                                                @click="redirectByItem(data)">{{ unescapeHtml(data.itemName) }}</a>
                                        </p>
                                        <div class="sale_area">
                                            <div class="price">
...
export default {
    ...
    methods: {
        ...
        redirectByItem(item) {
            this.viewDetails('/items/' + item.itemUserCode, 'paging', 'spot');
