                    ...
                    <ul id="img_grid" class="img_inner" v-masonry transition-duration="0.5s" item-selector=".img_area">
                        <li v-masonry-tile class="img_area" v-for="(data, index) in books" :key="'book_' + index">
                            ...
                            <div class="hover_area">
                                <a href=".pop_style_book" class="btn_sns" data-toggle="modal"
                                    @click="viewDetail(index)"><span>스타일<br>확인하기</span></a>
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="style_list">
                            <div class="look_img">
                                <img class="img_full" :src="itemImage(detail.image)" :alt="unescapeHtml(detail.title)"
                                    @error="errorImage">
                            </div>
                            <div class="style_conts">
                                ...
                                <div class="txt_bot" v-if="detail.items.length > 0">
                                    ...
                                    <div class="item_list thumb">
                                        <div class="row">
                                            <div class="col-6 list_area" v-for="(data, index) in detail.items"
                                                :key="'item_' + index">
                                                <div class="img_area">
                                                    <a :href="'/items' + data.itemUserCode">
                                                        <img :src="itemImage(data.itemImage)"
                                                            :alt="unescapeHtml(data.itemName)">
                                                    </a>
                                                    <div class="sale_per" v-if="data.discountRate > 0">{{ data.discountRate
                                                    }}<span>%</span></div>
                                                </div>
                                                <div class="txt_area">
                                                    ...
                                                    <div class="price_area">
                                                        <p class="before" v-if="data.salePrice > data.presentPrice">
                                                            <span>{{ formatNumber(data.salePrice) }}</span>원
                                                        </p>
                                                        <div class="sale_area">
                                                            <p class="price"><span>{{ formatNumber(data.presentPrice)
                                                            }}</span>원</p>
                                                        </div>
                                                    </div>
                                                </div>
